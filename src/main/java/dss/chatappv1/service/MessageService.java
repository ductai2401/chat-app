    ...
    public class MessageService {
        ...
        public Page<Message> findMessagesByReceiverName(String receiverName, Pageable pageable){
            return messageRepository.findMessagesByReceiverName(receiverName, pageable);
        }
    }
