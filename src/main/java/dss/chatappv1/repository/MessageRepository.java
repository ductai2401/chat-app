...
public interface MessageRepository extends JpaRepository<Message, Long> {
    ...
    @Query(value = "SELECT * FROM messages m WHERE (m.receiver_name = :receiverName) ORDER BY m.time DESC ", nativeQuery = true)

    Page<Message> findMessagesByReceiverName(@Param("receiverName") String receiverName, Pageable pageable);
}
